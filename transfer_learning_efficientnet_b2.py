...
def create_model(hp):
    base_model = EfficientNetV2B2(include_top=False, weights='imagenet', input_shape=(480, 640, 3))
    
    # Unfreeze the last few layers
    num_unfrozen_layers = hp.Int('num_unfrozen_layers', min_value=1, max_value=7)
...
def main():
    ...
    tuner = RandomSearch(
        ...
        project_name='efficientnetb2_points_of_interest'
    )
   ...
   # Search for the best hyperparameters
    ...
    best_model.fit(x_train, y_train, epochs=50, batch_size=16, validation_data=(x_test, y_test), callbacks=[early_stopping, reduce_lr])
  ...
  # Make predictions
    ...
    best_model.save("efficientnetb2_points_of_interest_savedmodel")
